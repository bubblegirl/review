...
\hline
P-CTX-1, P=CTX-1B & I & 1111.6 & Moray eel (\emph{Gymnothorax javanicus}) \citep{murata1990structures,lewis1991purification} & P-CTX-1 0.35 $\mu$g/kg \citep{murata1990structures}; P-CTX-1B 0.25$\mu$g/kg \citep{lewis1991purification} \\
\hline
P-CTX-2 & I & 1095.5 \citep{lewis1991purification} & Moray eel (\emph{Gymnothorax javanicus}) \citep{lewis1991purification} & 2.3 $\mu$g/kg \citep{lewis1991purification} \\
\hline
 P-CTX-3 & I & 1095.5 \citep{lewis1991purification} & Moray eel (\emph{Gymnothorax javanicus}) \citep{lewis1991purification} & 0.9 $\mu$g/kg \citep{lewis1991purification} \\
\hline
 P-CTX-4A & I & 1061.6 \citep{yasumoto2000structural} & \emph{Gambierdiscus} sp. \citep{yasumoto2000structural}; \emph{G. polynesiensis} \citep{chinain2010growth} & 12$\mu$g/kg \citep{chinain2010growth} \\
\hline
 P-CTX-4B & I & 1061.6 \citep{yasumoto2000structural} & \emph{Gambierdiscus} sp. \citep{yasumoto2000structural}; \emph{G. polynesiensis} \citep{chinain2010growth} & 20$\mu$g/kg \citep{chinain2010growth}\\
\hline
 P-CTX-3C & II & 1023.6 \citep{satake1993structure} &  \emph{Gambierdiscus} sp. \citep{satake1993structure}; \emph{G. polynesiensis} \citep{chinain2010growth} & 2.5$\mu$g/kg \citep{chinain2010growth}\\
\hline
 P-49-epi-CTX-3C & II & 1023.6 \citep{chinain2010growth} & \emph{Gambierdiscus} sp. \citep{satake1993structure}; \emph{G. polynesiensis} \citep{chinain2010growth} & 8$\mu$g/kg\citep{chinain2010growth}\\
\hline
 P-M-seco-CTX-3C & II & 1041.6 \citep{chinain2010growth} &\emph{Gambierdiscus} sp. \citep{satake1993structure}; \emph{G. polynesiensis} \citep{chinain2010growth} & 10$\mu$g/kg \citep{chinain2010growth}\\
\hline
 C-CTX-1 & III & 1141.6 \citep{vernoux1997isolation,pottier2002characterisation} & Horse-eye jack (\emph{Caranx latus}) \citep{vernoux1997isolation,pottier2002characterisation} & 3.6$\mu$g/kg \citep{vernoux1997isolation}\\
\hline
 C-CTX-2 & III & 1141.6 \citep{vernoux1997isolation,pottier2002characterisation}& Horse-eye jack (\emph{Caranx latus}) \citep{vernoux1997isolation,pottier2002characterisation} & Toxic \citep{vernoux1997isolation}\\
\hline
 I-CTX-1 & N/A & 1141.6 \citep{hamilton2002isolation}& Red bass (\emph{Lutjanus bohar}); Red emperor (\emph{Lutjanus sebae}) \citep{hamilton2002isolation} & Toxic \citep{hamilton2002isolation} \\
\hline
\end{tabular}
\end{sidewaystable}
\FloatBarrier
...
MTXs are the largest known proteinacious natural product \citep{yokoyama1988some,murata1993structure} and are highly toxic Ca$^{2+}$ channel activators with a LD$_{50}$ 0.05 $\mu$g/kg - there are only a couple of bacterial, proteinacious toxins with higher potency known \citep{yokoyama1988some,murata1993structure}. However the Ca$^{2+}$ activation is a secondary process of MTX activity, the primary mode of action in mammalian cells  is still unclear \citep{van2000diversity}. They are water soluble, polyether ladder compound first isolated form herbivorous Acanthurids fish gut in 1976 \citep{yasumoto1976toxicity}. Their complex structure and stereochemistry was elucidated in the 90s using stereoscopic studies and partial synthesis \citep{murata1993structure,murata1994structure,satake1995structural,nonomura1996complete,zheng1996complete}. \\
There are three isolated MTXs - designated MTX-1, MTX-2 and MTX-3, isolated from a \emph{Gambierdiscus} sp. in Queensland, Australia \citep{holmes1994purification}. The first two are structurally larger than the third and it is suspected, though unproven, that MTX-1 is synonymous with the MTX first isolated. \\ %who isolated it first? yokoyama? 
Initially in the 70s, MTXs were detected only in the guts of fish \citep{yasumoto1976toxicity}, so the prevalent theory that followed has been that they are irrelevant in CFP research due to the assumption that their water soluble nature would exclude them from being absorbed into flesh in concentrations relevant for bioaccumulation. This popular theory needs to be reconsidered, as earlier in the year a fish feeding study conducted by Kohli et al that demonstrated MTX were present in snapper liver, digestive organs and muscle in concentrations high enough to measure via LC-MS. In this study snapper were fed juvenile mullet, injected with a known quantity of \emph{G. australes} - a strain characterised to only produce MTX \citep{kohli2014feeding}. These findings make it imperative that the involvement of MTX in CFP, as well as the mode of action of MTX in humans, is established. 
