...
Stemming from the initial observation by Yasumoto et al in 197x, it is widely accepted that herbivorous or omnivorous fish consume \emph{Gambierdiscus} cells directly and start the bioacdcumualtion process  the progression of bioaccumulation in the food web resulting in CFP 
...
---> check with Mak (or Xu?) what types of CTXs were prevalent in Mullet, if those were caught.
