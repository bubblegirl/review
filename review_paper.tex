...
\begin{landscape}
\begin{longtable}{ |  p{3.5cm} | p{7cm} | p{4.5cm} | p{4cm} | }
\caption{Geographical distribution of different \emph{Gambierdiscus} spp. and their associated toxin profile.} \\
\hline
\textbf{Species} & \textbf{Geographical Distribution} & \textbf{Toxicity through assays} & \textbf{Toxicity through LC-MS} \\
\hline
\emph{G. toxicus}  & Tahiti, French Polynesia \cite{}; Mexican Caribbean \cite{}; New Caledonia \cite{}; Reunion Island \cite{}; Nha Trang, Vietnam \cite{} &  &  \\
  \hline
 \emph{G. belizeanus} & Belize \cite{}, Florida, USA \cite{}; Mexican Caribbean \cite{}; Malaysia \cite{}; Pakistan \cite{}; Queensland, Australia \cite{}; St. Barthelemy Island, Caribbean \cite{} &  &  \\
  \hline
 \emph{G. yasumotoi}   & Singapore \cite{}; Japan \cite{}; Mexican Caribbean \cite{}; Queensland, Australia \cite{}; Nha Trang, Vietnam \cite{} &  &  \\
  \hline
 \emph{G. australes}   & French Polynesia \cite{}; Japan \cite{}; Cook Islands \cite{}; Hawaii, USA \cite{}; Pakistan \cite{} &  &  \\
  \hline
 \emph{G. pacificus}   & French Polynesia \cite{}; Marshall \& Society Islands, Micronesia \cite{}; Kota Kinabalu \& Sipandan Island, Malaysia \cite{}; Nha Trang, Vietnam \cite{} &  &  \\
  \hline
 \emph{G. polynesiensis}   & French Polynesia \cite{}; Canary Islands \cite{}; Pakistan \cite{}; Nha Trang, Vietnam \cite{} &  &  \\
  \hline
 \emph{G. caribaeus}   & Florida, USA \cite{}; Belize \cite{}; Tahiti, French Polynesia \cite{}; Palau, Hawai, USA \cite{}; Flower Garden Banks National Marine Sanctuary, USA \cite{}; Ocho Rios, Jamaica \cite{}; Bahamas \cite{}; Grand Cayman Islands \cite{}; Tol-truk, Micronesia \cite{}; Jeju Island, Korea \cite{} &  &  \\
  \hline
  \emph{G. carolinianus}  & North Carolina, USA \cite{}; Bermuda, Mexico \cite{}; Puerto Rico \cite{}; Flower Garden Banks National Marine Sanctuary, USA \cite{}; Ocho Rios, Jamaica \cite{}; Crete, Greece \cite{} &  &  \\
  \hline
 \emph{G. carpenteri}   &  &  &  \\
  \hline
 \emph{G. ruetzleri}   &  &  &  \\
 ...
 \emph{G. excentricus}   &  &  &  \\
  \hline
 \emph{Gambierdiscus} ribotype 1  &  &  &  \\
  \hline
 \emph{Gambierdiscus} ribotype 2 &  &  &  \\
  \hline
 ...
 \emph{Gambierdiscus} ribotype 6  &  &  &  \\
  \hline
 \emph{Gambierdiscus} sp. type 1 &  &  &  \\
  \hline
  \emph{Gambierdiscus} sp. type 2 &  &  &  \\
  \hline
  \emph{Gambierdiscus} sp. type 3 &  &  &  \\
  \hline
\end{longtable}
\end{landscape}
\FloatBarrier
