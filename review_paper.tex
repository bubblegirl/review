...
In contrast, a recent study of toxicity of the new \emph{Gambiersiscus} ribotypes 4, 5 and 6 found that the isolates from a ciguateric site were up to 4\- fold more toxic compared to isolates from a geographycally closely related non-ciguateric reference site \cite{xu2014distribution}. This could be due to CTX and/or MTX production varying in a ciguateric setting. Holland et al changed temperature settings to investigate differential toxicity, \\ %fix this
