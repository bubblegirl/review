...
Stemming from the initial discovery by Yasumoto et al in 1977, it is widely accepted that herbivorous or omnivorous fish consume \emph{Gambierdiscus} cells directly and start the bioaccumualtion process \cite{yasumoto1977finding} the progression of bioaccumulation in the food web resulting in CFP 
In 197x Yasumoto et al observed fish grazing on dead coral biomagnification
check out Helfrich Banner 63
...
---> check with Mak (or Xu?) what types of CTXs were prevalent in Mullet, if those were caught. // none caught - but omnivores showed lower concentration of CTX-3 than CTX-1 and -2, as well as herbivores in general 
