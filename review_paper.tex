...
\begin{longtable}{ |  p{2.8cm} | p{2.8cm} | p{2.8cm} | p{3.5cm} | p{2cm} | }
...
\hline
 \emph{G. yasumotoi} & (56.8$\pm$5.6)-(51.7$\pm$5.6)-(62.4$\pm$4.3) & Globular species larger than \emph{G. ruetzleri}; cell size exceeds 42 $\mu$m & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{holmes1998gambierdiscus,litaker2009taxonomy} \\
\hline
 \emph{G. ruetzleri} & (45.5$\pm$3.3)-(37.5$\pm$3.0)-(51.6$\pm$4.9) & Globular species smaller than \emph{G. yasumotoi}; cell size less than 42$\mu$m & SSU: ; D1-D3 LSU: ; D8-D10 LSU & \cite{litaker2009taxonomy} \\
\hline
 \emph{G. belizeanus} & (61.7$\pm$3.1)-(60.0$\pm$4.5)-(48.1$\pm$4.2) & Anterio-posteriously compressed species; narrow 1p plate; different 2' plate symmetry and size; heavily aerolated cell surface & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{litaker2009taxonomy,faust1995observation} \\
\hline
 \emph{G. pacificus} & (58.5$\pm$3.9)-(53.6$\pm$4.1)-(40.4$\pm$3.6) & Anterio-posteriously compressed species; narrow 1p plate; smooth cell surface; 2' hatch shaped & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{litaker2009taxonomy,chinain1999morphology} \\
\hline
 \emph{G. excentricus} & (97.8$\pm$8.0)-(83.0$\pm$10.0)-(37.0$\pm$3.0) & Anterio-posteriously compressed species; narrow 1p plate; smooth cell surface; 2’ rectangular shaped; cell size bigger than \emph{G. australes} (1.5 times wider and deeper) & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{litaker2009taxonomy} \\
\hline
 \emph{G. australes} & (72.5$\pm$3.8)-(63.4$\pm$5.0)-(38.7$\pm$3.8) & Anterio-posteriously compressed species; narrow 1p plate; smooth cell surface; 2’ rectangular shaped; smaller than \emph{G. excentricus} & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{chinain1999morphology,litaker2009taxonomy} \\
\hline
 \emph{G. caribaeus} & ($\pm$)-($\pm$)-($\pm$) & Anterio-posteriously compressed species; broad 1p plate; 2’ rectangular shaped; symmetric 4’’ & SSU: ; D1-D3 LSU: ; D8-D10 LSU & \cite{litaker2009taxonomy} \\
\hline
 \emph{G. carpenteri} & ($\pm$)-($\pm$)-($\pm$) & Anterio-posteriously compressed species; broad 1p plate; 2’ rectangular shaped; asymmetric 4’’ & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{litaker2009taxonomy} \\
\hline
 \emph{G. toxicus} & ($\pm$)-($\pm$)-($\pm$) & Anterio-posteriously compressed species; broad 1p plate; 2’ hatchet shaped; dorsal end 1p pointed & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{litaker2009taxonomy} \\
\hline
 \emph{G. polynesiensis} & ($\pm$)-($\pm$)-($\pm$) & Anterio-posteriously compressed species; broad 1p plate; 2’ hatchet shaped; dorsal end 1p oblique; smaller cell size than \emph{G. carolinianus} & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{litaker2009taxonomy} \\
\hline
 \emph{G. carolinianus} & ($\pm$)-($\pm$)-($\pm$) & Anterio-posteriously compressed species; broad 1p plate; 2’ hatchet shaped; dorsal end 1p oblique; larger cell size than \emph{G. polynesiensis} & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{litaker2009taxonomy} \\
\hline
 \emph{G. scabrosus} & ($\pm$)-($\pm$)-($\pm$) &  & SSU: ; D1-D3 LSU: ; D8-D10 LSU  & \cite{} \\
\hline
...
%amend with Ledreux 13, Xu 14, Rhodes 14
	...
	\hline
	\emph{G. yasumotoi} & Singapore \cite{holmes1998gambierdiscus}; Japan \cite{nishimura2013genetic}; Gulf of Aqaba, Jordan \cite{saburova2013new}; Kuwait \cite{saburova2013new}; Mexican Caribbean \cite{hernandez2004species}; Queensland, Australia \cite{}; Nha Trang, Vietnam \cite{} & MBA +ve \cite{} & N/A & N/A \\ %saburova 13 found in jordan
	\hline	
