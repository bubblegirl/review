...
Benthic dinoflagellates of the genus \emph{Gambierdiscus} R. Adachi \& Y. Fukuyo are the causative organism of ciguatera fish poisoning (CFP), as they produce the neurotoxic ciguatoxins (CTX) which bioaccumulate. The genus was discovered in 1977 with \emph{G. toxicus} and the taxon was considered monotypic till 1995, when \emph{G. belizeanus} was discovered. Since then the species concept has expanded to 12 described species (13 with Kirsty) and 6 ribo/species types, with new species still discovered this year (ALK in prep). The species concept is still incomplete with the undescribed species/ribotypes which adds to the global distribution of known species is hazy, along with sampling data preceding new species discovery causes species designation to be ambiguous (cite). Furthermore, which \emph{Gambierdiscus} spp. produce CTXs and need to be monitored for to prevent CFP outbreaks is not well understood (cite). Bioassays, such as MBA, N2A and FLIPR are good indicators of the toxicity of an organism, however toxin profile needs to be verified with LC-MS (cite).
