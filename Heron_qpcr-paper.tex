...
\FloatBarrier
\begin{longtable}{ | p{1cm} | p{3cm} | p{1cm} | p{4cm} | p{4cm} | }
...
\textbf{Sample ID}&\textbf{Macroalgal substrate}&\textbf{Spatial rep}&\textbf{\textit{G. lapillus} cell density}&\textbf{\textit{G. polynesiensis} cell density}\\
\hline
1&\emph{Padina} sp.&A&&\\
\hline
&\emph{Sargassum} sp.&B&&\\
