...
%Australia
Over 50\% of Australia's expansive coastline (total ~66,000km) is tropical or subtropical, hence considered potential habitat for \emph{Gambierdiscus} spp. \cite{kretzschmar2016characterization}. CFP is endemic to the Great Barrier Reef (GBR), however due to the complicated presentation of symptoms the predicted diagnosis rate is as low as 20\%. 
