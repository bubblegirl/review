...
Here here we have demonstrated that \emph{G. lapillus} was an epiphyte to \emph{Chnoospora} sp., \emph{Padina} sp. and \emph{Sargassum} sp. Further, \emph{G. lapillus} also colonised \emph{Halimeda} sp. \cite{kretzschmar2016characterization}.
