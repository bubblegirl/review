...
\author{Key words:Ciguatera fish poisoning, \emph{Gambierdiscus lapillus}, Quantitative PCR assay}%,\\ \emph{Gambierdiscus polynesiensis}
\date{}
\begin{document}
\maketitle
...
To assess the presence of these species in the pelagic environment adjacent to macroalgal beds, plankton nets were dragged through the current (samples 34 - 38 %TODO work out which samples
...
%TODO work out which tow nets, then add to map
\begin{table}
