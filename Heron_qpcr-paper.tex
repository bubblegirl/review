...
\title{Development of semi-quantitative PCR assays for the detection and enumeration of \emph{Gambierdiscus lapillus} and \emph{Gambierdiscus polynesiensis} (Gonyaulacales, Dinophyceaes) at the Great Barrier Reef, Australia.}
\author{me}
\date{}
\begin{document}
\maketitle
...
The genus was discovered in 1977 with \emph{G. toxicus} Adachi \& Fukuyo \citep{adachi1979thecal} and the taxon was considered monotypic till 1995, when \emph{G. belizeanus} Faust was discovered \citep{faust1995observation}. To date the genus comprises of 13 described species and 6 ribo/species types
...
%Australia
CFP is endemic to the Great Barrier Reef (GBR), however due to the complicated presentation of symptoms the predicted diagnosis rate is as low as 20\% \citep{lewis2006ciguatera}. The recorded cases of CFP in Queensland  ranged from 7 to 69 annual cases between 2011 and 2015, which, considering the 20\% predicted report rate, project to 35 to 345 cases (Table ~\ref{tbl:CFPTable}). Conversely, the fatal traffic accidents in Queensland in 2011 totalled 269 incidents, less than the 2015 projected CFP incidences \cite{qldtraffic}.
\FloatBarrier
\begin{table}
...
\end{table}
\FloatBarrier
Yet while the threat of CFP is present, little is known about the distrubution of \emph{Gambierdiscus} in Australia.
Over 50\% of Australia's expansive coastline (total ~66,000km) is tropical or subtropical, hence considered potential habitat for \emph{Gambierdiscus} spp. \cite{kretzschmar2016characterization}. 
The 4 species of \emph{Gambierdiscus} that have been identified from Queensland and New South Wales are as follows: \emph{G. belizeanus} \citep{murray2014molecular}, \emph{G. cheloniae} \cite{smith2016new}, \emph{G. carpenteri} \citep{kohli2014high}, \emph{G. lapillus} \cite{kretzschmar2016characterization} and \emph{G. toxicus} \citep{hallegraeff2010algae}, as well as \emph{F. paulensis} (identified as \emph{F. yasumotoi}  by Murray et al. (2014) \citep{murray2014molecular}, reclassified by \cite{laza2016characterization}). Using pyrosequencing, \textit{Gambierdiscus} was identified \emph{Gambierdiscus} to the genus level in Western Australia \citep{kohli2014cob} , indicating that this is a coastline that should be examined further for CFP risk. Despite the prevalence of CFP in Australia, a species of \textit{Gambierdiscus} that consistently produces ciguatoxins has not yet been identified.
...
For the target amplicons of both \emph{G. lapillus} and \emph{G. polynesiensis}, a corresponding synthetic DNA (with an extra 50bp at either end), gBlocks \textsuperscript{\textregistered} gene fragment was synthesised by Integrated DNA Technologies.
%add more info
