...
Some CTXs undergo biotransformation during uptake of vector species  {\huge (find ref}). %different types between different trophic levels
...
Heron Island is located in the Great Barrier Reef, Queensland, Australia, and was chosen as a sample site due to CFP reports in the area (ref - litaker maybe?).\\ The samples were taken while snorkeling around the Heron Island research station, by members of Peter Ralph's research team. Due to this, the exact location is not known but an estimate is marked on Fig XX. The average temperature in October 2013, when HG1 was sampled, was 23.5 DG (cite heron data). The sea surface temperature at time of sampling HG4, HG5, HG6, HG7 and HG 26 in July 2014 was 20 DG, as recorded by the research team. Water temperature and salinity were not recorded (table ~\ref{tbl:StrainTable}).

\FloatBarrier
\begin{figure} 
\includegraphics[scale=.5]{Heron_samplecollection_mapAV.png} 
...
\FloatBarrier
\begin{figure} 
\includegraphics[scale=.6]{Rarotonga_samplecollection_mapAV.png} 
\caption{Maximum Likelyhood phylogeny of Heron Island \textit{Gambierdiscus} isolates using sequences amplified from the D8D10 LSU region.} 
\end{figure} 
\FloatBarrier 
...
\begin{tabular}{ | p{1.1cm} | p{1.8cm} | p{3cm} | p{2.5cm} | p{2cm} | p{4cm} | }
\hline
\textbf{Strain} & \textbf{Date} & \textbf{Location} & \textbf{Water Temperature (C)} & \textbf{Salinity (psu)} & \textbf{Method} \\
 \hline
 HG1 & October, 2013 & Heron Island, Australia & N/A & N/A & \emph{Padina} sp., shaken water sample \\
  \hline
