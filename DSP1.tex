...
\emph{Gambierdiscus toxicus} is a dinoflagellate, a type of marine microalgae, and is epiphytic on many substrates in shallow tropical and sub-tropical waters \cite{berdalet2012global}. The first evidence that \emph{Gambierdiscus} may produce toxins causing ciguatera fish poisoning (CFP), a severe seafood-borne illness, was found in 1977 \cite{yasumoto1977finding}.  
...
\hline
 ...
 \hline
 \emph{F. paulensis} & (50$\pm$3)-(45$\pm$2)-(56$\pm$3) & Globular species smaller than \emph{F. yasumotoi} and larger than \emph{F. rutzleri} & \cite{gomez2015fukuyoa}\\
 \hline
  \emph{F. ruetzleri} & (45.5$\pm$3.3)-(37.5$\pm$3.0)-(51.6$\pm$4.9) & Globular species smaller than \emph{F. yasumotoi}; cell size less than 42$\mu$m & \cite{litaker2009taxonomy} \\
 \hline
 \emph{F. yasumotoi} & (56.8$\pm$5.6)-(51.7$\pm$5.6)-(62.4$\pm$4.3) & Globular species larger than \emph{F. ruetzleri}; cell size exceeds 42 $\mu$m & \cite{holmes1998gambierdiscus,litaker2009taxonomy} \\
...
CFP is the most common non bacterial illness associated with seafood consumption, posing a global problem \cite{friedman2008ciguatera}. CFP has been reported in the Caribbean, Pacific and Indian Oceans. %CFP problem ref! + seafood trade
...
\begin{figure} 
\includegraphics[scale=.85]{map_oz.png}
\caption{Sites where \emph{Gambierdiscus} isolates have been reported in Australia. Site 1 indicates Raine Island, QLD; site 2 indicates Townsville, QLD; Site 3 indicates Heron Island, QLD; Site 4 indicated Platypus Bay, QLD; site 5 indicates Wapengo Lagoon, NSW; site 6 indicates Merimbula, NSW; site 7 indicates Eden, NSW; and site 8 indicates Exmouth, WA.} 
\label{fig:OzSites}
\end{figure} 
\FloatBarrier

\emph{F. yasumotoi} has been found in lacations spanning a 1550km length of the Great Barrier Reef. Isolates were found at Raine Island (site 1 in fig. ~\ref{fig:OzSites}), Nelly Bay at Townsville (site 2 in fig. ~\ref{fig:OzSites}) and Heron Island (site 3 in fig. ~\ref{fig:OzSites}) \cite{murray2014molecular}. \emph{F. yasumotoi} was MTX positive for MBA \cite{holmes1998gambierdiscus}, however in a New Zealand strain no known CTX or MTX analogues were detected vua LC-MS, though a variant of MTX may be present \cite{rhodes2014gambierdiscus}.

\emph{G. toxicus} has been found in both NSW and QLD. In NSW, the samples were found in Eden (site 7 in ~\ref{fig:OzSites}) \cite{hallegraeff2010algae}, while in QLD it was found at Platypus Bay, Townsville (site 2 in ~\ref{fig:OzSites}) \cite{hallegraeff2010algae}. \emph{G. toxicus} tested CTX positive via RBA \cite{chinain2010growth} and MTX positive via MBA \cite{chinain1999morphology} but these bioassay results have not yet been verified by LC-MS.\\
...
\hline
 ...
 \hline
  \emph{F. paulensis} & N/A & N/A & KM886379.1 &  \cite{gomez2015fukuyoa}\\
 \hline
  \emph{F. ruetzleri} & EF202962-64 & EF498081-85 & EF202853-60 & \cite{litaker2009taxonomy} \\
 \hline
 \emph{F. yasumotoi} & EF202965-68 & EF498087-89 &EF202846-52 & \cite{holmes1998gambierdiscus,litaker2009taxonomy} \\
 \hline
...
Dinoflagellates have some unique genetic features in both structure and regulation. Their genetic material extensively features repetitive genomic elements, high gene copy number and a large genome size ranging between 1.5 and 245 Gb.% \cite{lin2011genomic}.
...
%insert theoretical toxin evol here, especially Shauna's sxt paper
...
Dinoflagellate specific PKS encoding transcripts to date sport a singular catalytic domain for approximately 50 - 100 kDa proteins, reminiscent of the multi protein complex formation of type II PKS but sequence similarity is akin to type I PKS \cite{monroe2008toxic,eichholz2012putative}. Due to this unique feature, they are termed type I-like PKS \cite{monroe2010characterization}.
 \\ %ref kohli 15, google trawl dino pks
...
% A Evidence suggests that the production of CTXs and MTXs varies between species \cite{chinain2010growth,holland2013differences}, similar to the situation in other dinoflagellates, in which toxin production is highly variable between species, and generally stable within species.
...
The samples were taken while snorkelling around the Heron Island research station, by members of Peter Ralph's research team.  \emph{Halimedia} sp. or \emph{Padina} sp. were collected and shaken in seawater, which was then filtered (table ~\ref{tbl:StrainTable}). The average temperature in October 2013, when HG1 was sampled, was 23.5 $^{\circ}$C. The sea surface temperature at time of sampling HG4, HG5, HG6, HG7 and HG 26 in July 2014 was 20 $^{\circ}$C.
...
\FloatBarrier
\begin{figure} 
\includegraphics[scale=.8]{Heron_samplecollection_mapAV.png} 
\caption{Aproximate site (blue dot) on Heron Island where \textit{Gambierdiscus} isolates were collected from.} 
\label{fig:HeroSam}
\end{figure} 
\FloatBarrier
 
CFP is prevalent in the Cook Islands, and cases are becoming more common. The incidence rate steadily increased from 2 cases per 100,000 persons in 1998 to 1,554 cases per 100,000 people in 2008 \cite{skinner2011ciguatera}. \emph{G. polynesiensis} has been isolated from Rarotonga previously, and CTX production confirmed via LC-MS \cite{rhodes2014production}.
...
\begin{figure} 
\includegraphics[scale=.5]{Rarotonga_samplecollection_mapAV.png} 
...
SEM will be conducted by Mona Hoppenrath at the Senckenberg institute, Germany. \\
...
Cells from HG4, HG5, HG6 and HG7 were harvested from 1.2L cultures on day 13 during the late exponential phase, using 5 $\mu$m Durapore filters. Cells were washed off filters with F/10 and pelleted by centrifugation at 15000 rpm for 10 minutes. The cell pellet was washed thrice with PBS and cells broken down with Zirkonium beads by bead beating. The lysate was extracted with Tri-Reagent (Life Technologies) as per manufacturer's protocol. The RNA was purified with the RNeasy Plant mini kit (Qiagen, Limberg, Netherlands) as per the manufacturer's protocol. The eluent was treated with the TURBO DNA-free Kit (Life Technologies) to remove residual DNA. RNA quantity and quality was measured by Nanodrop (Thermo Fischer, NanoDrop 2000) and the integrity by Agilent 2100 Bioanalyser  at the Ramaciotti centre (UNSW).

HG4 and HG5 were chosen for further processing as they represent two distinct clades in the \emph{Gambierdiscus} phylogeny (fig. ~\ref{fig:HGSSU}) and the bioanalyser showed well defined 18S and 28S peaks (fig. ~\ref{fig:bioan}. The cDNA library was sequenced by Ramaciotti with 75bp pair ends and 250bp inserts.

\begin{figure} 
\includegraphics[scale=.3]{Bioan.png} 
\caption{Bioanalyzer results for \textit{Gambierdiscus} isolates HG4 (A) and HG5 (B).} 
\label{fig:bioan}
\end{figure} 
\FloatBarrier 
Bioan.png
...
\subsection{Characterisation of Heron Island and Cook Island strains}
The morphological characteristics need to be inferred from SEM, and compared with other described species (table ~\ref{tbl:MorphTable}). The cell size of the new clade needs to be meassured under the light microscope, for all four strains and at a statistically relevant quantity.
...
How high the coverage is of the transcriptomes extracted will be determined by matching the transcripts against the non-redundant (nr) database curated by NCBI using the HPC cluster at UTS. The results will be screened for essential proteins as an indicator of sequencing depth. Furthermore, the transcriptomes will be matched against the known dinoSL sequences as an indication of how many transcripts were covered.\\

The search for PKS will be conducted with the aid of the HPC cluster. The transcriptomes will be manipulated with Geneious \cite{kearse2012geneious}, then transcripts will be run against a hmmer library assembled with the minimum necessary catalytic domains of PKSs. Results will be verified with NCBI's Conserved Domain Database (CDD).\\

The results from this part of the project will be used to build a phylogeny of PKS found in \emph{Gambierdiscus} spp., to be matched against the phylogeny from the concatenated phylogeny of \emph{Gambierdiscus}. This will give an indication of how the toxin production has evolved in this organism - whether it is confined to a clade or if toxin production was present in a common ancestor and has been lost in some species as was found in saxitoxin production in \emph{Alexandrium} \cite{murray2015gene}. This will give an indicator whether closely related genera, as ascertained by the gonyaulacales phylogeny, may also be CTX or MTX producers. 



\subsection{PKS expression in \emph{Gambierdiscus} strains}
The experimental design for this section is currently being developed. To address whether PKS expression is affected by environmental factors, RNA will extracted from cultures subjected to different conditions. How the differential expression will be quantified depends on the outcome of the previous section. Microarray is an option, as is qPCR. These options will be explored closer to execution of this experiment.
