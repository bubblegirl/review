...
It is highly likely that many more \emph{Gambierdiscus} species were present even at those particular sites examined, as in each case, the studies represent only single or short term sampling events at one location within a site. Therefore the toxicity and distribution of \emph{Gambierdiscus} species around Australia remains largely unknown. %Consequently, the causative agent for CFP in Australia has not yet been determined. \\
...
Cells of \emph{Gambierdiscus spnov}, anterioposteriorly compressed and round to ellipsoid in apical view (Fig. ~\ref{fig:PetLM}). Cells were small, dorsoventral depth of 40.6 $\mu$m (range of 34.4 - 50.9 $\mu$m; standard deviation 3.3$\mu$m) and width of 39 $\mu$m (range of 32 - 46.9 $\mu$m; standard deviation 3.2$\mu$m) with a depth to width ratio of 1.04 (standard deviation 0.06$\mu$m)  (n=128). 
The cell surface hada strong reticulate-foveate ornamentation, apical and antapical plates with regularly arranged deep depressions containing a pore  and pre- and postcingular plates more irregularly reticulated (Fig. ). Flagella 2. The plate formula, via Kofoid tabulation, is Po, 4', 0a, 6'', 6c, 8s, 6''', 1p, 2''''. 
The apical pore plate (Po) is oval with a fish-hook shaped slit-like apical pore, located close to the center of the epitheca, slightly shifted ventrally  (Fig. ~\ref{fig:PetSEM}F). The largest apical plate is the hatchet-shaped 2' plate, followed by the hexagonal 3' plate and the hexagonal 1' plate is the smallest. The largest precingular plate was plate 3'  (four-sided, covering the left lateral precingular area) and the pentagonal 4’’ plate (dorsal) was nearly of the same size. Plates 5’’ and 6’’ were on the right lateral side. Plates 1” and 7’’ were the smallest (Fig. ~\ref{fig:PetSEM}A, B and C) located ventrally. The largest postcingular plate was the 4”’ plate (covering most of the left hypotheca), followed by the plates 2”’, 3”’, 5”’ and 1”’. The quadrangular first antapical plate (1””) was small and the larger, relatively narrow pentagonal 2”” plate that covered the antapex (Fig. ~\ref{fig:PetSEM}D). The sulcus was a deep excavation (Fig. xx). The narrow and deep cingulum was difficult to observe and consisted of ? plates  (Fig. ~\ref{fig:PetSEM}E).\\
A few cells displayed shape-variability of plate 2’ (Fig. zz). The shape varied from hatchet shaped (main morphology) to nearly rectangular (Fig. x) and 6-sided (Fig. y). Some of the cells were tear-drop shaped rather than ellipsoid. 
...
\FloatBarrier 
\begin{figure} 
%\includegraphics[scale=.02]{spnov_SEM.png} 
