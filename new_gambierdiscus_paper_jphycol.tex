...
The cell surface had a strong  reticulate-foveate ornamentation (Figs. %TODO work out fig referencing here NOT orn
...
The plate formula (Kofoid tabulation) was Po, 3', 0a, 7'', 6c, 7-8s, 5''', 0p, 2'''' (Figs. ). %TODO work out figs here 
...
The largest apical plate was the hatchet-shaped 2' plate, followed by the pentagonal 3' plate and the hexagonal 1' plate (Fig. c, a-d, a). %TODO figs 
The largest precingular plate was plate 3'' (four-sided, covering the left lateral precingular area) and the pentagonal 4'' plate (dorsal) was nearly of the same size (Figs. a-d, a). %TODO figs 
Plates 5'' and 6'' were on the right lateral side (Figs. a, a). %TODO figs 
Plates 1'' and 7'' were the smallest (Fig. b, c, a) located ventrally. %TODO figs 
The largest postcingular plate was the 4''' plate (covering most of the left hypotheca), followed by the plates 2''', 3''', 5''' and 1''' (Figs a-b, b). %TODO figs 
The quadrangular first antapical plate (1'''') was small and the larger, relatively narrow pentagonal 2'''' plate that covered the antapex (Fig.a-b, b). %TODO figs 
The sulcus was a deep excavation (Fig. c, g) and composed of seven to eight plates (Fig. S ). %TODO figs
The narrow and deep cingulum was difficult to observe and consisted of six plates (Fig. S ). %TODO figs
A few cells displayed shape variability of plate 2' (Fig. S~\ref{fig:varSEM}c-e). %TODO figs
The shape varied from hatchet shaped (main morphology) to nearly rectangular (Fig. S~\ref{fig:varSEM}c) and six-sided (Fig. S~\ref{fig:varSEM}e).%TODO figs 
Some of the cells were tear-drop shaped rather than ellipsoid (Fig. S~\ref{fig:varSEM}a-c). %TODO figs
...
Comparing the distinguishing morphological characteristics between \emph{G. lapillus} sister species is the \textit{G. lapillus}'s diminutive size (Figs. ). %TODO figs 
...
\emph{Gambierdiscus lapillus} also differs to \emph{G. scabrosus} due to it's symmetric 4'' plate (Fig. ~\ref{fig:epiSEM}a), hence it is closer morphologically to \emph{G. belizeanus}. %TODO check fig
The morphological point of difference between the two species lies in the 2' plate (Fig. ). %TODO fig 
The 2' plate of \emph{G. lapillus} is hatchet shaped (Fig. ~\ref{fig:epiSEM}a-d) whereas the 2' plate of \emph{G. belizeanus} is rectangular (Fig. 3 in \citep{faust1995observation}). %TODO check fig^
...
A small subset of isolates displayed some variability morphological features, and were different to the majority of cells, in the 2' plate as well as cell shape (Fig. S). %TODO figs suool 
