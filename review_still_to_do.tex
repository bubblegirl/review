...
\hline
 Grouper & \emph{Cephalopholis argus} (Blue spotted grouper) & Nuku Hiva, French Polynesia \cite{darius2007ciguatera}; French Polynesia \cite{bagnis1987use}; Hawaii, USA \cite{campora2008detection} & CTX +ve \cite{darius2007ciguatera,campora2008detection,bagnis1987use} & Cat BA \cite{bagnis1987use}; ELISA \cite{campora2008detection}; MBA \cite{bagnis1987use};  MQBA \cite{bagnis1987use}; N2A \cite{campora2008detection}; RBA \cite{darius2007ciguatera} \\
  ...
  &  \emph{Serranidae} & French West Indies \cite{pottier2002characterisation,pottier2003identification} & CTX-1 \cite{pottier2002characterisation,pottier2003identification}; CTX-2 and isomers \cite{pottier2002characterisation,pottier2003identification}; CTX congeners and other \cite{pottier2002characterisation,pottier2003identification} & MBA \cite{pottier2002characterisation,pottier2003identification} \\ % CHECK OUT THIS REF TO GET A SPECVUES ... da fuck really? MBA gives that much resolution?
