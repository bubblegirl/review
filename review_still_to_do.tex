...
\hline
 Grouper & \emph{Cephalopholis argus} (Blue spotted grouper) & Nuku Hiva, French Polynesia \cite{darius2007ciguatera}; French Polynesia \cite{}; Hawaii, USA \cite{} & CTX +ve \cite{} & Cat BA \cite{}; ELISA \cite{}; MBA \cite{};  MQBA \cite{}; N2A \cite{}; RBA \cite{} \\
  ...
  & \emph{Epinephelus coioides} (Orange-spotted grouper) & Hong Kong \cite{} & CTX +ve \cite{} & MBA \cite{} \\
  & \emph{Epinephelus lanceolatus} (Giant grouper) & Hong Kong \cite{} & CTX +ve \cite{} & MBA \cite{}  \\
  &  \emph{Epinephelus microdon} (Marble grouper) & French Polynesia \cite{} & CTX +\cite{} & Cat BA \cite{}; MBA \cite{}; MQBA \cite{} \\
