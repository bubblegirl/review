...
Sequencing data was aligned with \emph{Gambierdiscus} spp. data from the GenBank reference database (accession numbers as part of fig. ~\ref{fig:HGD8D10} and fig. ~\ref{fig:HGSSU}). The allignment algorithm MUSCLE, with a maximum of 8 iterations \cite{edgar2004muscle}, was used through the Geneious software, version 8.1.7 \cite{kearse2012geneious}. Alignments were truncated to the same length (D10-D8 and SSU at 799bp and 1690bp respectively), and discrepancies removed.
...
More specifically, \emph{G. petramus} differs to \emph{G. scabrosus} due to it's symmetric 4'' plate (fig. ~\ref{fig:PetSEM}), hence it is closer morphologically to \emph{G. belizeanus}. This is, however, not reflected in their evolutionary relationship which shows the two species several branches removed (fig. ~\ref{fig:HGD8D10} and fig. ~\ref{fig:HGSSU}). The morphological point of difference between the two species lies in the 2' plate. \emph{G. petramus}'s 2' plate is hatchet shaped (fig. ~\ref{fig:PetSEM}A, B and C) while the \emph{G. belizeanus}'s is rectangular \cite{faust1995observation}. \\
...
Kohli et al observed similar morphological deviation from species description in  \emph{G. carpenteri} \cite{kohli2014high}. Strains of \emph{G. carpenteri}, as verified by sequencing, exhibited the key morphological characteristics of \emph{G. toxicus} (broad 1p plates pointed dorsal ends and lack of dorsal rostrum) \cite{kohli2014high,litaker2009taxonomy}.
...
Despite CFP being a problem endemic to Australia, the causative agent has proven elusive. To our knowledge, this study constitutes the first report of a CTX producer in Australia. The LC-MS toxin profile of \emph{G. petramus} shows an undescribed congener of CTX, which indicates that this species is part of the ciguateric web in the GBR.
The toxicity of \emph{G. petramus} is equally unusual. Whole cell extract MBAs were conducted to query the toxicity as it would be encountered in an environmental setting. The pathology of the mice affected was unusual and not indicative of previously reported MTX or CTX intoxication (Pers. comm. Rex Munday). Whether the abnormal pathology is due to the unknown CTX congener or another toxin produced by this species is unknown. Further fractionation of whole cell extracts into aqueous methanol and dichloromethane partitions, which are expected to contain MTX from CTX respectively \cite{satake1993structure} could be conducted to isolate which toxin is likely causing the pathology.
The toxicity of \emph{Gambierdiscus} spp. in culture have been observed to fluctuate wildly (pers. comm. Tim Harwood). This was observed in the highly variable toxicity of \emph{G. petramus} isolates in the MBA, where the toxicity of HG6 was xxx-fold as high as HG4.  The recorded intra species toxicity variation of \emph{G. polynesiensis} via MBA was only 2-fold \cite{chinain2010growth}. Proposed reasons for changing toxin production are Phosphorous limitation in the media, different stages of the growth phase and growth rate \cite{sperr1996variation,chinain2010growth}. However the HG4, HG6 and HG7 were grown under the same conditions and harvested simultaneously which indicates a intra strain variation in toxin production.\\
...
\paragraph{Holotype:} Fig. xx; SEM-stub (designation xxx) deposited at the Senckenberg Research Institute, German Centre for Marine Biodiversity Research, Wilhelmshaven, Germany. \emph{Mona} I assume these will be stored with you? Could you please fill in this section.
\paragraph{Isotype:} Fig. xx; SEM-stub (designation xxx) deposited at the Senckenberg Research Institute, German Centre for Marine Biodiversity Research, Wilhelmshaven, Germany. \emph{Mona} I assume these will be stored with you? Could you please fill in this section.
...
Dr Rex Munday for conducting the toxicology investigation.
 \FloatBarrier
\begin{table}
...
\hline
 ...
 \hline
 \emph{G. belizeanus}  & Site 3: Heron Island, GBR \cite{murray2014molecular} & CTX +ve via RBA \cite{chinain2010growth}; MTX +ve via HELA \cite{holland2013differences} & NA  \\
 \hline
 \emph{G. carpenteri} &Site 5: Wapengo Lagoon, NSW \cite{kohli2014high}; site 6:  Merimbula, NSW  \cite{kohli2014high}& MTX +ve via MBA \cite{kohli2014high} & N/D \cite{kohli2014high}\\
 \hline
 \emph{G. toxicus} & Site 2: Townsville, GBR \cite{hallegraeff2010algae}; Site 7: Eden, NSW \cite{hallegraeff2010algae} & CTX +ve via RBA \cite{chinain2010growth}; MTX +ve via MBA \cite{chinain1999morphology} & NA \\
  \hline
  \emph{Gambierdiscus} sp. &Site 8: Exmouth, WA \cite{kohli2014cob}& NA & NA \\
  \hline
 \emph{F. yasumotoi}  & Site 1: Raine Island, GBR \cite{murray2014molecular}; Site 2: Townsville, GBR \cite{murray2014molecular}; site 3: Heron Island, GBR \cite{murray2014molecular}& MTX +ve via MBA \cite{holmes1998gambierdiscus} & N/D \cite{rhodes2014gambierdiscus}\\
  \hline
\end{tabular}
\end{table}
\FloatBarrier
