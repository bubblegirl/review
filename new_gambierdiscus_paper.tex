...
The sister groups to \emph{G. spnov} n the phylogeny were found to be \emph{G. pacificus} and \emph{G. toxicus} (fig. ~\ref{fig:HGD8D10} and fig. ~\ref{fig:HGSSU}). The nodal support for both BI and ML for the SSU rDNA region is 1.00 and 100 respectively. For the D8-D10 LSU region, the confidence of the relationship of \emph{G. spnov} with it's closest relatives is lower. \begin{large}
Instert correct terminology
\end{large}
The resolution of \emph{G. spnov} as a separate species is with high confidence, 1.00 and 100 for BI and ML respectively. The BI of the species' relationships was still high, whereas the ML confidence was reduced. %ref other papers.. xu for example
