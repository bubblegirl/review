...
HG4, HG6, HG7 and HG7 were fixed with 10 \% Lugol's iodide and examined with an inverted light microscope ( xxx) equipped with xx camera for cell size. Depth (D: measured along dorsal-ventral axis) and width (W: measured along the lateral axis) was meassured for 30 to 36 cells per strain.
...
\FloatBarrier
\begin{table}
\caption{Morphological meassurements for all characterised \emph{Gambierdiscus} spp. and \emph{Fukoyoa} spp. Values in parentheses are $\pm$ standard deviation.}
...
\textbf{Taxa} &  \textbf{D ($\mu$m)} & \textbf{W ($\mu$m)}  & \textbf{D:W ratio} & \textbf{Reference} \\
 \hline
 G. australes	& 72.5 (3.8) &	63.4 (5.0)	& & \cite{chinain1999morphology,litaker2009taxonomy} \\
 \hline
 G. belizeanus	& 61 ($\pm$6) & 57.2 ($\pm$5.2) & 1.07 ($\pm$0.08) & \cite{nishimura2014morphology} \\
 \hline
 G. caribaeus	& 82.2 ($\pm$7.6)	& 81.9 ($\pm$7.9)	& & \cite{litaker2009taxonomy}\\
 \hline
 G. carolinianus & 78.2 ($\pm$4.8) & 87.1 ($\pm$7.1) & & \cite{litaker2009taxonomy} \\
 \hline
 G. carpenteri &	81.7 ($\pm$6.4) &	74.8 ($\pm$5.9) & & \cite{litaker2009taxonomy} \\
 \hline
 G. excentricus	& 97.8 ($\pm$8.0) &	83.0 ($\pm$10.0)	& & \cite{litaker2009taxonomy} \\
 \hline
 G. pacificus	& 70 ($\pm$4.7) & 63 ($\pm$3.6) & 1.11 (NA)	& \cite{litaker2009taxonomy}\\
 \hline
 G. polynesiensis & 66.3 ($\pm$3.0) & 60.5 ($\pm$5.9) & &	\cite{litaker2009taxonomy,chinain1999morphology} \\ 
 \hline
 G. scabrosus	& 63.2 ($\pm$5.7) & 58.2 ($\pm$5.7) & 1.09 ($\pm$0.07) & \cite{nishimura2014morphology}\\
 \hline
 G. silvae	& 69 ($\pm$8.0) & 64 ($\pm$9.0) & & \cite{fraga2014genus,litaker2010global}\\
 \hline
 ...
 \hline
 F. yasumotoi & 56.8 ($\pm$5.6)	& 51.7 ($\pm$5.6) & & \cite{litaker2009taxonomy} \\
 \hline
...
Variability in toxicity - seen in other dinos? How about between Alexandrium species?
